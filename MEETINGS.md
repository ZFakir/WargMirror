...
Log of check-ins with our assigned tutor (client). Per [`METHODOLOGY.md`](./METHODOLOGY.md), we meet with our tutor weekly; entries are added after each meeting going forward.
...
- Talked through our internal process — twice-weekly check-ins, GitHub Projects board, group-agreed task assignment, peer review before merge (see [`METHODOLOGY.md`](./METHODOLOGY.md))
