...
This page describes how our team actually plans, assigns, and tracks work over the course of the project. It complements the [Git Policy](./git-policy), which covers our *version control* conventions specifically; this page covers our day-to-day *development process*.
...
Notes from meetings with our tutor (decisions made, action items, stakeholder feedback) are logged on the [Stakeholder Meetings](./meetings) page.
...
1. The work is opened as a PR against `main` (per our [Git Policy](./git-policy))
...
- **Twice-weekly fixed check-ins** keep the group aligned often enough to catch drift early, without the overhead of daily standups.
