# WARG Platform — Deployment Guide
...
2. [Aiven — MySQL Database](#1-aiven--mysql-database)
3. [Render — Backend Hosting](#2-render--backend-hosting)
4. [Vercel — Frontend Hosting](#3-vercel--frontend-hosting)
